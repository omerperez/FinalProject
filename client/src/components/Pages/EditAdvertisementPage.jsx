...
export default function EditAdvertisementPage() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:8080/message/show/" + id)
...
//   screens: [String],
  ...
  const [messageName, setMessageName] = useState(message.messageName);
  const [textFields, setTextFields] = useState(message.textFields);
  const [title, setTitle] = useState(message.title);
  const [visableTime, setVisableTime] = useState(message.visableTimeInSec);
  const [template, setTemplate] = useState(message.templateSrc);
  ...
  return (
    <>
      <PageTitle page={"Manage " + message.title} />
      <div className="pr-1 pl-1">
        <div className="pr-5 pl-1 mt-3">
                        ...
                        <div className="col d-flex justify-content-center">
                          <FormControl fullWidth>
                            ...
                            <Select
                              ...
                              id="template"
                              label={"Template" + message.templateSrc}
                              value={template}
